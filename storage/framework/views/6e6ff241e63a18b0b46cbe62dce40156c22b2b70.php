<aside class="col-lg-3 sidebar sidebar-fixed sidebar-toggle-remain shop-sidebar sticky-sidebar-wrapper">
							...
							<div class="sidebar-content">
								<div class="pin-wrapper" style="height: 1673.88px;"><div class="sticky-sidebar" data-sticky-options="{'top': 10}" style="border-bottom: 0px none rgb(102, 102, 102); width: 272.5px;">
...
'margin': 20											}">
												<!-- End Products Col -->
												<!-- End Products Col -->
											<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-585px, 0px, 0px); transition: all 0s ease 0s; width: 1755px;"><div class="owl-item cloned" style="width: 272.5px; margin-right: 20px;"><div class="products-col">
												...
												</div></div><div class="owl-item cloned" style="width: 272.5px; margin-right: 20px;"><div class="products-col">
													<div class="product product-list-sm">
														<figure class="product-media">
															<a href="product.html">
																<img src="images/shop/product-widget1.jpg" alt="product" width="100" height="100">
												...
												</div></div><div class="owl-item active" style="width: 272.5px; margin-right: 20px;"><div class="products-col">
													<div class="product product-list-sm">
														<figure class="product-media">
															<a href="product.html">
																<img src="images/shop/product-widget1.jpg" alt="product" width="100" height="100">
												...
												</div></div><div class="owl-item" style="width: 272.5px; margin-right: 20px;"><div class="products-col">
													<div class="product product-list-sm">
														<figure class="product-media">
															<a href="product.html">
																<img src="images/shop/product-widget1.jpg" alt="product" width="100" height="100">
