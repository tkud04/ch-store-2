...
<section class="about-section">
                ...
                <section class="reviews-section grey-section pt-10 pb-10">
                    <div class="container appear-animate" data-animation-options="{'name':'fadeInRightShorter'}">
                        ...
                        <div class="owl-carousel owl-shadow-carousel owl-same-height owl-theme pb-4 owl-loaded owl-drag" data-owl-options="{
                            'items': 3,
                            'nav': false,
                            'dots': true,
                            'loop': false,
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1200px;"><div class="owl-item active" style="width: 380px; margin-right: 20px;"><div class="testimonial testimonial-centered bg-white">
                                <div class="testimonial-info">
                                    <h3 class="testimonial-title">Highly Recommend</h3>
                                    <figure class="testimonial-author-thumbnail">
                                        <img src="images/reviewer-1.png" alt="user" width="70" height="70">
                                    </figure>
                            ...
                            </div></div><div class="owl-item active" style="width: 380px; margin-right: 20px;"><div class="testimonial testimonial-centered bg-white">
                                <div class="testimonial-info">
                                    <h3 class="testimonial-title">Very Helpful</h3>
                                    <figure class="testimonial-author-thumbnail">
                                        <img src="images/reviewer-2.png" alt="user" width="70" height="70">
                                    </figure>
                                    <blockquote>“ Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus
                                        hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque ”</blockquote>
                                    <cite>
                                ...
                                <div class="testimonial-info">
                                    ...
                                    <figure class="testimonial-author-thumbnail">
                                        <img src="images/reviewer-3.png" alt="user" width="70" height="70">
                                    </figure>
                                    <blockquote>“ Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus
                                        hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque ”</blockquote>
                                    <cite>
                            ...
                            </div></div></div></div><div class="owl-nav disabled"><button type="button" role="presentation" class="owl-prev"><i class="d-icon-angle-left"></i></button><button type="button" role="presentation" class="owl-next"><i class="d-icon-angle-right"></i></button></div><div class="owl-dots disabled"></div></div>
                    </div>
                </section>
