				...
				<div style="border: 3px solid #000!important; padding: 8px!important;">
				  ...
				  <div id="sd-edit">
				   <form>
					 ...
					 <a href="javascript:void(0)" id="sd-cancel" class="btn btn-sm btn-primary mt-5" style="text-align: right;">Done</a>
					 <a href="javascript:void(0)" id="sd-done" class="btn btn-sm btn-primary mt-5" style="text-align: right;">Cancel</a>
				   </form>
				  </div>
				</div>
		     </div>	
