									 ...
									 <div class="col-md-4 col-6 mb-4">
                                        <div class="product text-center" itemscope itemtype="http://schema.org/Product">
                                            <figure class="product-media">
                                                <a href="{{$uu}}">
                                                    <img src="{{$imgs[0]}}" alt="product" width="280" height="315" itemprop='image'>
                                                </a>
                                                <div class="product-label-group">
                                                    <label class="product-label label-new">new</label>
                                                </div>
                                                <div class="product-action-vertical">
                                                    <a href="javascript:void(0)" class="btn-product-icon btn-cart" onclick="addToCart({xf: '{{$xf}}'})" title="Add to cart"><i class="d-icon-bag"></i></a>
                                                    <a href="javascript:void(0)" class="btn-product-icon btn-wishlist" onclick="addToWishlist({xf: '{{$xf}}'})" title="Add to wishlist"><i class="d-icon-heart"></i></a>
                                                </div>
