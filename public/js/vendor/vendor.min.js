!function(t, e) {
    ...
    var n, o = "alert", a = "bs.alert", l = "." + a, c = p.fn[o], d = {
        CLOSE: "close" + l,
        CLOSED: "closed" + l,
    ...
    p(document).on(d.CLICK_DATA_API, '[data-dismiss="alert"]', u._handleDismiss(new u)),
    ...
    ;
    var f, m = "button", v = "bs.button", b = "." + v, y = ".data-api", w = p.fn[m], x = "active", S = '[data-toggle^="button"]', T = ".btn", _ = {
        ...
        if (n) {
            ...
            if (i) {
                if ("radio" === i.type)
                    if (i.checked && this._element.classList.contains(x))
                        t = !1;
                    else {
                ...
                if (t) {
                    if (i.hasAttribute("disabled") || n.hasAttribute("disabled") || i.classList.contains("disabled") || n.classList.contains("disabled"))
                        return;
                    i.checked = !this._element.classList.contains(x),
                    p(i).trigger("change")
                }
                i.focus(),
                e = !1
        ...
        e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(x)),
        t && p(this._element).toggleClass(x)
    }
    ,
    f.dispose = function() {
    ...
    p(document).on(_.CLICK_DATA_API, S, function(t) {
        t.preventDefault();
        var e = t.target;
        p(e).hasClass("btn") || (e = p(e).closest(T)),
    ...
    p.fn[m] = C._jQueryInterface,
    p.fn[m].Constructor = C,
    p.fn[m].noConflict = function() {
        return p.fn[m] = w,
        C._jQueryInterface
    }
    ;
    var k, $ = "carousel", A = "bs.carousel", I = "." + A, D = ".data-api", L = p.fn[$], P = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    }, N = "active", R = ".active.carousel-item", F = {
        TOUCH: "touch",
        PEN: "pen"
    ...
    k._slide = function(t, e) {
        var n, i, o, r = this, s = this._element.querySelector(R), a = this._getItemIndex(s), l = e || s && this._getItemByDirection(t, s), c = this._getItemIndex(l), d = Boolean(this._interval);
        ...
        l && p(l).hasClass(N))
            ...
            if (p(this._element).hasClass("slide")) {
                ...
                p(s).one(g.TRANSITION_END, function() {
                    p(l).removeClass(n + " " + i).addClass(N),
                    p(s).removeClass(N + " " + i + " " + n),
                    r._isSliding = !1,
                    setTimeout(function() {
    ...
    p.fn[$] = W._jQueryInterface,
    p.fn[$].Constructor = W,
    p.fn[$].noConflict = function() {
        return p.fn[$] = L,
        W._jQueryInterface
    }
    ;
    var q, Y = "collapse", X = "bs.collapse", B = "." + X, U = p.fn[Y], V = {
        toggle: !0,
        parent: ""
    }, K = {
        toggle: "boolean",
    ...
    }, Z = "show", G = "collapse", J = "collapsing", tt = "collapsed", et = '[data-toggle="collapse"]', nt = ((q = it.prototype).toggle = function() {
    ...
    q.show = function() {
        ...
        t && (e = p(t).not(this._selector).data(X)) && e._isTransitioning))) {
            ...
            !i.isDefaultPrevented()) {
                ...
                p(this._element).removeClass(G).addClass(J),
                ...
                p(this._element).one(g.TRANSITION_END, function() {
                    p(n._element).removeClass(J).addClass(G).addClass(Z),
                    n._element.style[o] = "",
    ...
    q.hide = function() {
        ...
        if (!this._isTransitioning && p(this._element).hasClass(Z)) {
            ...
            !e.isDefaultPrevented()) {
                ...
                p(this._element).addClass(J).removeClass(G).removeClass(Z);
                ...
                p(this._element).one(g.TRANSITION_END, function() {
                    ...
                    p(t._element).removeClass(J).addClass(G).trigger(Q.HIDDEN)
    ...
    q._getConfig = function(t) {
        return (t = s({}, V, t)).toggle = Boolean(t.toggle),
        g.typeCheckConfig(Y, t, K),
        t
    }
    ,
    ...
    p.fn[Y] = nt._jQueryInterface,
    p.fn[Y].Constructor = nt,
    ...
    function mt(t) {
        ...
        for (var e = gt(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling; )
    ...
    function bt(t, e) {
        ...
        if (t !== l && e !== l || i.contains(o))
            return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && mt(s.firstElementChild) !== s ? mt(l) : l;
        var c = vt(t);
    ...
    function Dt(t, e, n, i, o) {
        ...
        return s.left += f ? n : n.left || 0,
        s.top += f ? n : n.top || 0,
        s.right -= f ? n : n.right || 0,
        s.bottom -= f ? n : n.bottom || 0,
        s
    }
    ...
    function Nt(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && ct(e) && (n.offsets.popper = kt(n.offsets.popper),
    ...
    function qt(n, i) {
        Object.keys(i).forEach(function(t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && zt(i[t]) && (e = "px"),
            n.style[t] = i[t] + e
        })
    }
        ...
        modifiers: {
                ...
                fn: function(t, i) {
                    ...
                    var c = i.priority
                      ...
                      , u = {
                        primary: function(t) {
                            var e = d[t];
                            return d[t] < l[t] && !i.escapeWithReference && (e = Math.max(d[t], l[t])),
                            Tt({}, t, e)
                        },
                        secondary: function(t) {
                            var e = "right" === t ? "left" : "top"
                              , n = d[e];
                            return d[t] > l[t] && !i.escapeWithReference && (n = Math.min(d[e], l[t] - ("right" === t ? d.width : d.height))),
                            Tt({}, e, n)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    t.arrowElement = i,
                    t.offsets.arrow = (Tt(n = {}, u, Math.round(y)),
                    Tt(n, h, ""),
                    n),
                    t
                },
            ...
            flip: {
                ...
                fn: function(p, g) {
                    ...
                    return w.forEach(function(t, e) {
                        ...
                        v = p.placement.split("-")[0],
                        b = Mt(v);
                        var n, i = p.offsets.popper, o = p.offsets.reference, r = Math.floor, s = "left" === v && r(i.right) > r(o.left) || "right" === v && r(i.left) < r(o.right) || "top" === v && r(i.bottom) > r(o.top) || "bottom" === v && r(i.top) < r(o.bottom), a = r(i.left) < r(m.left), l = r(i.right) > r(m.right), c = r(i.top) < r(m.top), d = r(i.bottom) > r(m.bottom), u = "left" === v && a || "right" === v && l || "top" === v && c || "bottom" === v && d, h = -1 !== ["top", "bottom"].indexOf(v), f = !!g.flipVariations && (h && "start" === y && a || h && "end" === y && l || !h && "start" === y && c || !h && "end" === y && d);
                        (s || u || f) && (p.flipped = !0,
                        (s || u) && (v = w[e + 1]),
                        f && (y = "end" === (n = y) ? "start" : "start" === n ? "end" : n),
                        p.placement = v + (y ? "-" + y : ""),
                        p.offsets.popper = Ct({}, p.offsets.popper, Ht(p.instance.popper, p.offsets.reference, p.placement)),
                        p = Nt(p.instance.modifiers, p, "flip"))
                    }),
                    p
                },
                behavior: "flip",
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var s, a, l, c, d, u, h, f, p, g, m, v, b, y, w, x, S = void 0 !== r ? r : e.gpuAcceleration, T = mt(t.instance.popper), _ = $t(T), C = {
                        position: o.position
                    }, E = (s = t,
                    a = window.devicePixelRatio < 2 || !Yt,
                    ...
                    y = a ? u : f,
                    {
                        ...
                        bottom: y(c.bottom),
                        right: b(c.right)
                    }), k = "bottom" === n ? "top" : "bottom", $ = "right" === i ? "left" : "right", A = Ft("transform");
                    if (x = "bottom" == k ? "HTML" === T.nodeName ? -T.clientHeight + E.bottom : -_.height + E.bottom : E.top,
                    w = "right" == $ ? "HTML" === T.nodeName ? -T.clientWidth + E.right : -_.width + E.right : E.left,
                    S && A)
                        C[A] = "translate3d(" + w + "px, " + x + "px, 0)",
                        C[k] = 0,
                        C[$] = 0,
                    ...
                    return t.attributes = Ct({}, L, t.attributes),
                    t.styles = Ct({}, C, t.styles),
    ...
    function Zt(t, e) {
        ...
        Object.keys(Ct({}, Zt.Defaults.modifiers, i.modifiers)).forEach(function(t) {
    ...
    Qt.Utils = ("undefined" != typeof window ? window : global).PopperUtils,
    Qt.placements = Bt,
    Qt.Defaults = Kt;
    var Gt, Jt = "dropdown", te = "bs.dropdown", ee = "." + te, ne = ".data-api", ie = p.fn[Jt], oe = new RegExp("38|40|27"), re = {
        HIDE: "hide" + ee,
        HIDDEN: "hidden" + ee,
        SHOW: "show" + ee,
        SHOWN: "shown" + ee,
    ...
    }, se = "disabled", ae = "show", le = "dropdown-menu-right", ce = '[data-toggle="dropdown"]', de = ".dropdown-menu", ue = {
        offset: 0,
        flip: !0,
            ...
            !e) {
                ...
                !i.isDefaultPrevented()) {
                    if (!this._inNavbar) {
                        ...
                        var o = this._element;
                        "parent" === this._config.reference ? o = t : g.isElement(this._config.reference) && (o = this._config.reference,
                        ...
                        this._popper = new Qt(o,this._menu,this._getPopperConfig())
                    }
    ...
    Gt._getConfig = function(t) {
        ...
        g.typeCheckConfig(Jt, t, this.constructor.DefaultType),
        t
    }
    ,
    ...
    pe._dataApiKeydownHandler = function(t) {
        if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(de).length)) : oe.test(t.which)) && (t.preventDefault(),
        t.stopPropagation(),
    ...
    p(document).on(re.KEYDOWN_DATA_API, ce, fe._dataApiKeydownHandler).on(re.KEYDOWN_DATA_API, de, fe._dataApiKeydownHandler).on(re.CLICK_DATA_API + " " + re.KEYUP_DATA_API, fe._clearMenus).on(re.CLICK_DATA_API, ce, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        fe._jQueryInterface.call(p(this), "toggle")
    }).on(re.CLICK_DATA_API, ".dropdown form", function(t) {
        t.stopPropagation()
    }),
    p.fn[Jt] = fe._jQueryInterface,
    p.fn[Jt].Constructor = fe,
    p.fn[Jt].noConflict = function() {
        return p.fn[Jt] = ie,
        fe._jQueryInterface
    }
    ;
    var ge, me = "modal", ve = "bs.modal", be = "." + ve, ye = p.fn[me], we = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
    ...
    }, Te = "modal-open", _e = "fade", Ce = "show", Ee = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", ke = ".sticky-top", $e = ((ge = Ae.prototype).toggle = function(t) {
    ...
    ge.show = function(t) {
        ...
        if (!this._isShown && !this._isTransitioning) {
            ...
            p(this._element).on(Se.CLICK_DISMISS, '[data-dismiss="modal"]', function(t) {
                return e.hide(t)
            }),
    ...
    ge.hide = function(t) {
        ...
        this._isShown && !this._isTransitioning) {
            ...
            this._isShown && !n.isDefaultPrevented()) {
                ...
                this._setEscapeEvent(),
                this._setResizeEvent(),
                p(document).off(Se.FOCUSIN),
                p(this._element).removeClass(Ce),
                p(this._element).off(Se.CLICK_DISMISS),
                p(this._dialog).off(Se.MOUSEDOWN_DISMISS),
                i) {
    ...
    ge._hideModal = function() {
        ...
        this._isTransitioning = !1,
        this._showBackdrop(function() {
            p(document.body).removeClass(Te),
            t._resetAdjustments(),
            t._resetScrollbar(),
            p(t._element).trigger(Se.HIDDEN)
        })
    }
    ,
    ...
    ge._showBackdrop = function(t) {
        ...
        if (this._isShown && this._config.backdrop) {
            ...
            p(this._element).on(Se.CLICK_DISMISS, function(t) {
                e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide())
            }),
            n && g.reflow(this._backdrop),
            p(this._backdrop).addClass(Ce),
            !t)
                return;
            if (!n)
                return void t();
    ...
    p.fn[me] = $e._jQueryInterface,
    p.fn[me].Constructor = $e,
    p.fn[me].noConflict = function() {
        return p.fn[me] = ye,
        $e._jQueryInterface
    }
    ;
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(t, e) {
            ...
            o.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === Ie.indexOf(n) || Boolean(t.nodeValue.match(De) || t.nodeValue.match(Le));
    ...
    var Oe, Me = "tooltip", He = "bs.tooltip", je = "." + He, Ne = p.fn[Me], Re = "bs-tooltip", Fe = new RegExp("(^|\\s)" + Re + "\\S+","g"), We = ["sanitize", "whiteList", "sanitizeFn"], ze = {
        animation: "boolean",
        template: "string",
    ...
    Oe.toggle = function(t) {
        if (this._isEnabled)
            if (t) {
                ...
                if (p(this.getTipElement()).hasClass(Ve))
    ...
    Oe.show = function() {
        ...
        if (this.isWithContent() && this._isEnabled) {
            ...
            this.setContent(),
            this.config.animation && p(o).addClass(Ue);
            ...
            this._popper = new Qt(this.element,o,{
                placement: a,
                modifiers: {
                    offset: this._getOffset(),
                    flip: {
    ...
    Oe.setContent = function() {
        ...
        p(t).removeClass(Ue + " " + Ve)
    }
    ,
    Oe.setElementContent = function(t, e) {
        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Pe(e, this.config.whiteList, this.config.sanitizeFn)),
    ...
    Oe._enter = function(t, e) {
        ...
        t && (e._activeTrigger["focusin" === t.type ? Qe : Ke] = !0),
        p(e.getTipElement()).hasClass(Ve) || e._hoverState === Xe ? e._hoverState = Xe : (clearTimeout(e._timeout),
        e._hoverState = Xe,
    ...
    Oe._leave = function(t, e) {
        ...
        (e = e || p(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
        p(t.currentTarget).data(n, e)),
        t && (e._activeTrigger["focusout" === t.type ? Qe : Ke] = !1),
    ...
    Oe._getConfig = function(t) {
        ...
        g.typeCheckConfig(Me, t, this.constructor.DefaultType),
    ...
    Oe._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (p(t).removeClass(Ue),
    ...
    Ge._jQueryInterface = function(n) {
        return this.each(function() {
            var t = p(this).data(He)
              , e = "object" == typeof n && n;
            if ((t || !/dispose|hide/.test(n)) && (t || (t = new Ge(this,e),
            p(this).data(He, t)),
            "string" == typeof n)) {
                if (void 0 === t[n])
                    throw new TypeError('No method named "' + n + '"');
    ...
    p.fn[Me] = Ze._jQueryInterface,
    p.fn[Me].Constructor = Ze,
    p.fn[Me].noConflict = function() {
        return p.fn[Me] = Ne,
        Ze._jQueryInterface
    }
    ...
    p.fn[Je] = cn._jQueryInterface,
    p.fn[Je].Constructor = cn,
    p.fn[Je].noConflict = function() {
        return p.fn[Je] = nn,
        cn._jQueryInterface
    }
    ;
    var dn, un = "scrollspy", hn = "bs.scrollspy", fn = "." + hn, pn = p.fn[un], gn = {
        offset: 10,
        method: "auto",
        target: ""
    }, mn = {
    ...
    }, bn = "active", yn = ".nav, .list-group", wn = ".nav-link", xn = ".list-group-item", Sn = "position", Tn = ((dn = _n.prototype).refresh = function() {
        var e = this
    ...
    dn._getConfig = function(t) {
        ...
        return g.typeCheckConfig(un, t, mn),
        t
    }
    ,
    ...
    dn._activate = function(e) {
        ...
        n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(bn),
        n.addClass(bn)) : (n.addClass(bn),
        n.parents(yn).prev(wn + ", " + xn).addClass(bn),
        n.parents(yn).prev(".nav-item").children(wn).addClass(bn)),
        p(this._scrollElement).trigger(vn.ACTIVATE, {
            relatedTarget: e
        })
    }
    ,
    ...
    _n._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new _n(this,"object" == typeof e && e),
            p(this).data(hn, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
                    throw new TypeError('No method named "' + e + '"');
    ...
    function _n(t, e) {
        ...
        this._config = this._getConfig(e),
        this._selector = this._config.target + " " + wn + "," + this._config.target + " " + xn + "," + this._config.target + " .dropdown-item",
        this._offsets = [],
        this._targets = [],
        this._activeTarget = null,
        this._scrollHeight = 0,
        p(this._scrollElement).on(vn.SCROLL, function(t) {
            return n._process(t)
        }),
        this.refresh(),
        this._process()
    ...
    p.fn[un] = Tn._jQueryInterface,
    p.fn[un].Constructor = Tn,
    p.fn[un].noConflict = function() {
        return p.fn[un] = pn,
        Tn._jQueryInterface
    }
    ;
    var Cn, En = "bs.tab", kn = "." + En, $n = p.fn.tab, An = {
        HIDE: "hide" + kn,
        HIDDEN: "hidden" + kn,
        SHOW: "show" + kn,
        SHOWN: "shown" + kn,
        ...
        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(In) || p(this._element).hasClass("disabled"))) {
            var t, i, e = p(this._element).closest(".nav, .list-group")[0], o = g.getSelectorFromElement(this._element);
            if (e) {
    ...
    p(document).on(An.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Pn._jQueryInterface.call(p(this), "show")
    }),
    ...
    ;
    var Mn, Hn = "toast", jn = "bs.toast", Nn = "." + jn, Rn = p.fn[Hn], Fn = {
        CLICK_DISMISS: "click.dismiss" + Nn,
        HIDE: "hide" + Nn,
        HIDDEN: "hidden" + Nn,
        SHOW: "show" + Nn,
        SHOWN: "shown" + Nn
    }, Wn = "show", zn = "showing", qn = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, Yn = {
        ...
        var t = this;
        function e() {
            t._element.classList.remove(zn),
            t._element.classList.add(Wn),
            p(t._element).trigger(Fn.SHOWN),
            t._config.autohide && t.hide()
        }
        if (p(this._element).trigger(Fn.SHOW),
    ...
    Mn.hide = function(t) {
        var e = this;
        this._element.classList.contains(Wn) && (p(this._element).trigger(Fn.HIDE),
    ...
    Mn.dispose = function() {
        clearTimeout(this._timeout),
        this._timeout = null,
        this._element.classList.contains(Wn) && this._element.classList.remove(Wn),
        p(this._element).off(Fn.CLICK_DISMISS),
    ...
    Mn._getConfig = function(t) {
        return t = s({}, Yn, p(this._element).data(), "object" == typeof t && t ? t : {}),
        g.typeCheckConfig(Hn, t, this.constructor.DefaultType),
        t
    }
    ,
    ...
    Mn._close = function() {
        function t() {
            ...
            p(e._element).trigger(Fn.HIDDEN)
        }
        var e = this;
    ...
    Bn._jQueryInterface = function(n) {
        return this.each(function() {
            var t = p(this)
              , e = t.data(jn);
            if (e || (e = new Bn(this,"object" == typeof n && n),
            t.data(jn, e)),
            "string" == typeof n) {
                if (void 0 === e[n])
                    throw new TypeError('No method named "' + n + '"');
    ...
    p.fn[Hn] = Xn._jQueryInterface,
    p.fn[Hn].Constructor = Xn,
...
function(t) {
    ...
    s.prototype.getLeft = function(t) {
        ...
        r.slideCount % r.options.slidesToScroll != 0 && t + r.options.slidesToScroll > r.slideCount && r.slideCount > r.options.slidesToShow && (s = t > r.slideCount ? (r.slideOffset = (r.options.slidesToShow - (t - r.slideCount)) * r.slideWidth * -1,
        (r.options.slidesToShow - (t - r.slideCount)) * n * -1) : (r.slideOffset = r.slideCount % r.options.slidesToScroll * r.slideWidth * -1,
        r.slideCount % r.options.slidesToScroll * n * -1))) : t + r.options.slidesToShow > r.slideCount && (r.slideOffset = (t + r.options.slidesToShow - r.slideCount) * r.slideWidth,
    ...
    s.prototype.getNavigableIndexes = function() {
        ...
        for (t = !1 === e.options.infinite ? e.slideCount : (n = -1 * e.options.slidesToScroll,
    ...
    s.prototype.getSlideCount = function() {
        ...
        !0 === o.options.swipeToSlide ? (o.$slideTrack.find(".slick-slide").each(function(t, e) {
            if (e.offsetLeft - i + c(e).outerWidth() / 2 > -1 * o.swipeLeft)
                return n = e,
                !1
        }),
    ...
    s.prototype.setSlideClasses = function(t) {
        ...
        !0 === r.options.centerMode) {
            ...
            !0 === r.options.infinite && (e <= t && t <= r.slideCount - 1 - e ? r.$slides.slice(t - e + s, t + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (i = r.options.slidesToShow + t,
            ...
            0 <= t && t <= r.slideCount - r.options.slidesToShow ? r.$slides.slice(t, t + r.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : n.length <= r.options.slidesToShow ? n.addClass("slick-active").attr("aria-hidden", "false") : (o = r.slideCount % r.options.slidesToShow,
    ...
    c.fn.slick = function() {
        ...
        for (t = 0; t < r; t++)
            if ("object" == typeof i || void 0 === i ? n[t].slick = new s(n[t],i) : e = n[t].slick[i].apply(n[t].slick, o),
            void 0 !== e)
                return e;
        return n
    }
...
function(t, e) {
    ...
    function l(t) {
        ...
        return !!a(e.target) || 1 < e.touches.length || (e.preventDefault && e.preventDefault(),
        !1)
    }
    function n() {
        setTimeout(function() {
            ...
            p = void 0),
            void 0 !== f && (document.body.style.overflow = f,
            f = void 0)
        })
    }
        ...
        if (c) {
            ...
            if (r && !d.some(function(t) {
                ...
                r.ontouchmove = function(t) {
                    var e, n, i, o;
                    1 === t.targetTouches.length && (n = r,
                    o = (e = t).targetTouches[0].clientY - h,
                    a(e.target) || (n && 0 === n.scrollTop && 0 < o ? l(e) : (i = n) && i.scrollHeight - i.scrollTop <= i.clientHeight && o < 0 ? l(e) : e.stopPropagation()))
                }
                ,
            ...
            setTimeout(function() {
                if (void 0 === p) {
                    ...
                    t && 0 < e && (p = document.body.style.paddingRight,
                    document.body.style.paddingRight = e + "px")
                }
                void 0 === f && (f = document.body.style.overflow,
...
function(t) {
    ...
    function s(t, e, n) {
        ...
        this.$el.on("finish.countdown", n)) : this.options = o.extend({}, i, n)),
        this.setFinalDate(e),
                    ...
                    if (a)
                        for (var l = 0, c = a.length; l < c; ++l) {
                            var d = a[l].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/)
                              , u = (r = d[0],
                            void 0,
                            s = r.toString().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"),
                            new RegExp(s))
                              , h = d[1] || ""
                              , f = d[3] || ""
                              , p = null;
                            d = d[2],
                            m.hasOwnProperty(d) && (p = m[d],
                            p = Number(g[p])),
                            null !== p && ("!" === h && (n = p,
                            o = i = void 0,
                            i = "s",
                            o = "",
                            (e = f) && (e = e.replace(/(:|;|\s)/gi, "").split(/\,/),
                            i = 1 === e.length ? e[0] : (o = e[0],
                            e[1])),
                            p = 1 < Math.abs(n) ? i : o),
                            "" === h && p < 10 && (p = "0" + p.toString()),
                            t = t.replace(u, p.toString()))
                        }
                    return t.replace(/%%/, "%")
                }
            }(this.offset),
    ...
    o.fn.countdown = function() {
        ...
        return this.each(function() {
            ...
            if (void 0 !== t) {
                var e = r[t]
                  , n = i[0];
                s.prototype.hasOwnProperty(n) ? e[n].apply(e, i.slice(1)) : null === String(n).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (e.setFinalDate.call(e, n),
                e.start()) : o.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, n))
            } else
                new s(this,i[0],i[1])
        })
    }
...
function(e, n) {
    ...
    function r(t, e, n) {
        if (!(this instanceof r))
            return new r(t,e,n);
        var i = t;
        return "string" == typeof t && (i = document.querySelectorAll(t)),
        i ? (this.elements = function(t) {
        ...
        void setTimeout(this.check.bind(this))) : void a.error("Bad element for imagesLoaded " + (i || t))
    }
    function n(t) {
        this.img = t
    }
...
function(a) {
    ...
    o.prototype.showTabs = function() {
        ...
        this.$accordion.find(".js-tabcollapse-panel-heading").detach().each(function() {
            ...
            e.parent().hasClass("dropdown-menu") && !e.siblings("li").hasClass("active") && e.parent().parent().removeClass("active"),
            n.hasClass("collapsed") ? n.removeClass("collapsed") : (e.addClass("active"),
            e.parent().hasClass("dropdown-menu") && e.parent().parent().addClass("active")),
            e.append(t)
        }),
    ...
    o.prototype.getTabContentElement = function() {
        ...
        return 0 === t.length && (t = this.$tabs.siblings(".tab-content")),
        t
    }
    ,
    o.prototype.showAccordion = function() {
        ...
        if (t.each(function() {
            var t = a(this)
              , e = t.parent();
            t.data("bs.tabcollapse.parentLi", e),
            n.$accordion.append(n._createAccordionGroup(n.$accordion.attr("id"), t.detach()))
        }),
    ...
    o.prototype._tabHeadingToPanelHeading = function(t, e, n, i) {
        return t.addClass("js-tabcollapse-panel-heading " + (i ? "" : "collapsed")),
        t.attr({
            "data-toggle": "collapse",
            "data-parent": "#" + n,
            href: "#" + e
    ...
    o.prototype._initAccordion = function() {
        ...
        this.$accordion = a('<div class="panel-group ' + this.options.accordionClass + '" id="' + e + '"></div>'),
    ...
    o.prototype._createAccordionGroup = function(t, e) {
        ...
        return s.find(".panel-heading > .panel-title").append(this._tabHeadingToPanelHeading(e, r, t, i)),
        s.find(".panel-body").append(o.contents().detach()).data("bs.tabcollapse.tabpane", o),
        s
    }
    ,
...
function(l, c, g) {
    ...
    function n(t, e) {
        ...
        (o = g.fancybox.getInstance()) && o.$trigger && o.$trigger.is(n) || (r = e.selector ? g(e.selector) : (i = n.attr("data-fancybox") || "") ? (r = t.data ? t.data.items : []).length ? r.filter('[data-fancybox="' + i + '"]') : g('[data-fancybox="' + i + '"]') : [n],
        (s = g(r).index(n)) < 0 && (s = 0),
        (o = g.fancybox.open(r, e, s)).$trigger = n))
    }
    ...
    g) {
        ...
        var t = {
          ...
          , i = function(t, e, n) {
            ...
            g.isPlainObject(e) && (i.opts = u(i.opts, e)),
            g.fancybox.isMobile && (i.opts = u(i.opts, i.opts.mobile)),
            i.id = i.opts.id || ++r,
        ...
        g.extend(i.prototype, {
            init: function() {
                ...
                !g.fancybox.getInstance() && !1 !== o.hideScrollbar && !g.fancybox.isMobile && c.body.scrollHeight > l.innerHeight && (g("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' + (l.innerWidth - c.documentElement.clientWidth) + "px;}</style>"),
                g("body").addClass("compensate-for-scrollbar")),
                n = "",
                g.each(o.buttons, function(t, e) {
                    n += o.btnTpl[e] || ""
                }),
                e = g(i.translate(i, o.baseTpl.replace("{{buttons}}", n).replace("{{arrows}}", o.btnTpl.arrowLeft + o.btnTpl.arrowRight))).attr("id", "fancybox-container-" + i.id).addClass(o.baseClass).data("FancyBox", i).appendTo(o.parentEl),
                i.$refs = {
                    container: e
                },
            ...
            addContent: function(t) {
                ...
                g.each(n, function(t, e) {
                    ...
                    g.fancybox.isMobile && a.opts.mobile && (a.opts = u(a.opts, a.opts.mobile)),
                    i = a.type || a.opts.type,
                    r = a.src || "",
                    !i && r && ((o = r.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (i = "video",
                    a.opts.video.format || (a.opts.video.format = "video/" + ("ogv" === o[1] ? "ogg" : o[1]))) : r.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? i = "image" : r.match(/\.(pdf)((\?|#).*)?$/i) ? (i = "iframe",
                    a = g.extend(!0, a, {
                        contentType: "pdf",
                        opts: {
                            iframe: {
                    ...
                    "ajax" !== a.type || 1 < (s = r.split(/\s+/, 2)).length && (a.src = s.shift(),
                    a.opts.filter = s.shift()),
            ...
            addEvents: function() {
                ...
                o.on("orientationchange.fb resize.fb", function(t) {
                    t && t.originalEvent && "resize" === t.originalEvent.type ? (i.requestId && e(i.requestId),
                    i.requestId = h(function() {
                        i.update(t)
                ...
                s.on("keydown.fb", function(t) {
                    var e = (g.fancybox ? g.fancybox.getInstance() : null).current
                      , n = t.keyCode || t.which;
                    if (9 != n)
                        return !e.opts.keyboard || t.ctrlKey || t.altKey || t.shiftKey || g(t.target).is("input,textarea,video,audio,select") ? void 0 : 8 === n || 27 === n ? (t.preventDefault(),
            ...
            jumpTo: function(t, i) {
                var e, n, o, r, s, a, l, c, d, u = this, h = u.group.length;
                if (!(u.isDragging || u.isClosing || u.isAnimating && u.firstRun)) {
                    if (t = parseInt(t, 10),
                    !(o = u.current ? u.current.opts.loop : u.opts.loop) && (t < 0 || h <= t))
                        return !1;
                    ...
                    u.prevPos = u.currPos,
                    r = u.createSlide(t),
                    1 < h && ((o || r.index < h - 1) && u.createSlide(t + 1),
                    (o || 0 < r.index) && u.createSlide(t - 1)),
                    u.current = r,
                    u.currIndex = r.index,
                    u.currPos = r.pos,
                    ...
                    g.isNumeric(i) ? r.forcedDuration = i : i = r.opts[e ? "animationDuration" : "transitionDuration"],
                    i = parseInt(i, 10),
                    n = u.isMoved(r),
                    ...
                    n ? (d = a.left - (s.pos * a.width + s.pos * s.opts.gutter),
                    g.each(u.slides, function(t, e) {
                        ...
                        e.pos !== r.pos && e.$slide.addClass("fancybox-slide--" + (e.pos > r.pos ? "next" : "previous")),
                        f(e.$slide),
                    ...
                    g.fancybox.animate(s.$slide, c, i, function() {
            ...
            scaleToActual: function(t, e, n) {
                var i, o, r, s, a, l = this, c = l.current, d = c.$content, u = g.fancybox.getTranslate(c.$slide).width, h = g.fancybox.getTranslate(c.$slide).height, f = c.width, p = c.height;
                ...
                o = .5 * u - .5 * f,
                r = .5 * h - .5 * p,
                u < f && (0 < (o = i.left * s - (t * s - t)) && (o = 0),
                o < u - f && (o = u - f)),
                h < p && (0 < (r = i.top * a - (e * a - e)) && (r = 0),
                r < h - p && (r = h - p)),
                l.updateCursor(f, p),
            ...
            getFitPos: function(t) {
                var e, n, i, o, r = t.$content, s = t.$slide, a = t.width || t.opts.width, l = t.height || t.opts.height, c = {};
                return !!(t.isLoaded && r && r.length) && (e = g.fancybox.getTranslate(this.$refs.stage).width,
                ...
                n -= parseFloat(s.css("paddingTop")) + parseFloat(s.css("paddingBottom")) + parseFloat(r.css("marginTop")) + parseFloat(r.css("marginBottom")),
                a && l || (a = e,
                l = n),
                e - .5 < (a *= i = Math.min(1, e / a, n / l)) && (a = e),
                n - .5 < (l *= i) && (l = n),
                "image" === t.type ? (c.top = Math.floor(.5 * (n - l)) + parseFloat(s.css("paddingTop")),
                c.left = Math.floor(.5 * (e - a)) + parseFloat(s.css("paddingLeft"))) : "video" === t.contentType && (a / (o = t.opts.width && t.opts.height ? a / l : t.opts.ratio || 16 / 9) < l ? l = a / o : l * o < a && (a = l * o)),
                c.width = a,
                c.height = l,
                c)
            },
            ...
            updateSlide: function(t, e) {
                var n = this
                  ...
                  , s = t.$slide;
                n.adjustCaption(t),
                i && (o || r || "video" === t.contentType) && !t.hasError && (g.fancybox.stop(i),
                g.fancybox.setTranslate(i, n.getFitPos(t)),
                t.pos === n.currPos && (n.isAnimating = !1,
                n.updateCursor())),
                n.adjustLayout(t),
                s.length && (s.trigger("refresh"),
                t.pos === n.currPos && n.$refs.toolbar.add(n.$refs.navigation.find(".fancybox-button--arrow_right")).toggleClass("compensate-for-scrollbar", s.get(0).scrollHeight > s.get(0).clientHeight)),
            ...
            isMoved: function(t) {
                ...
                return !!i && (n = g.fancybox.getTranslate(this.$refs.stage),
                e = g.fancybox.getTranslate(i.$slide),
                !i.$slide.hasClass("fancybox-animated") && (.5 < Math.abs(e.top - n.top) || .5 < Math.abs(e.left - n.left)))
            },
            updateCursor: function(t, e) {
                var n, i, o = this, r = o.current, s = o.$refs.container;
                r && !o.isClosing && o.Guestures && (s.removeClass("fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-zoomOut fancybox-can-swipe fancybox-can-pan"),
                i = !!(n = o.canPan(t, e)) || o.isZoomable(),
                s.toggleClass("fancybox-is-zoomable", i),
                g("[data-fancybox-zoom]").prop("disabled", !i),
                n ? s.addClass("fancybox-can-pan") : i && ("zoom" === r.opts.clickContent || g.isFunction(r.opts.clickContent) && "zoom" == r.opts.clickContent(r)) ? s.addClass("fancybox-can-zoomIn") : r.opts.touch && (r.opts.touch.vertical || 1 < o.group.length) && "video" !== r.contentType && s.addClass("fancybox-can-swipe"))
            },
            isZoomable: function() {
            ...
            isScaledDown: function(t, e) {
                var n = !1
                  , i = this.current
                  , o = i.$content;
                return void 0 !== t && void 0 !== e ? n = t < i.width && e < i.height : o && (n = (n = g.fancybox.getTranslate(o)).width < i.width && n.height < i.height),
                n
            },
            canPan: function(t, e) {
                var n = this.current
            ...
            setIframe: function(o) {
                ...
                o.$content = g('<div class="fancybox-content' + (s.preload ? " fancybox-is-hidden" : "") + '"></div>').css(s.css).appendTo(a),
                a.addClass("fancybox-slide--" + o.contentType),
                o.$iframe = r = g(s.tpl.replace(/\{rnd\}/g, (new Date).getTime())).attr(s.attr).appendTo(o.$content),
                s.preload ? (e.showLoading(o),
            ...
            setContent: function(t, e) {
                ...
                e.css("display", "inline-block")) : t.hasError || ("string" === g.type(e) && (e = g("<div>").append(g.trim(e)).contents()),
            ...
            adjustLayout: function(t) {
                ...
                0 < parseFloat(o) && (e = r.$slide[0].scrollHeight,
            ...
            revealContent: function(t) {
                var e, n, i, o, r = this, s = t.$slide, a = !1, l = !1, c = r.isMoved(t), d = t.isRevealed;
                return t.isRevealed = !0,
                e = t.opts[r.firstRun ? "animationEffect" : "transitionEffect"],
                i = t.opts[r.firstRun ? "animationDuration" : "transitionDuration"],
                i = parseInt(void 0 === t.forcedDuration ? i : t.forcedDuration, 10),
                !c && t.pos === r.currPos && i || (e = !1),
                "zoom" === e && (t.pos === r.currPos && i && "image" === t.type && !t.hasError && (l = r.getThumbPos(t)) ? a = r.getFitPos(t) : e = "fade"),
                "zoom" === e ? (r.isAnimating = !0,
                a.scaleX = a.width / l.width,
                a.scaleY = a.height / l.height,
                "auto" == (o = t.opts.zoomOpacity) && (o = .1 < Math.abs(t.width / t.height - l.width / l.height)),
                o && (l.opacity = .1,
                a.opacity = 1),
                g.fancybox.setTranslate(t.$content.removeClass("fancybox-is-hidden"), l),
                f(t.$content),
                ...
                void g.fancybox.animate(s, "fancybox-slide--current", i, function() {
                    s.removeClass(n).css({
                        transform: "",
                        opacity: ""
                    }),
            ...
            getThumbPos: function(t) {
                var e, n, i, o, r, s = !1, a = t.$thumb;
                return !(!a || !function(t) {
                    var e, n;
                    return !(!t || t.ownerDocument !== c) && (g(".fancybox-container").css("pointer-events", "none"),
                    e = {
                    ...
                    n)
                }(a[0])) && (e = g.fancybox.getTranslate(a),
                n = parseFloat(a.css("border-top-width") || 0),
                i = parseFloat(a.css("border-right-width") || 0),
            ...
            complete: function() {
                ...
                !n.isMoved() && e.isLoaded && (e.isComplete || (e.isComplete = !0,
            ...
            focus: function(t, e) {
                ...
                n.eq(n.length - 1).trigger("focus")) : (i < 0 || i == n.length - 1) && (t && t.preventDefault(),
            ...
            close: function(t, e) {
                ...
                var i, o, r, s, a, l, c, d = this, u = d.current;
                ...
                "auto" == (a = u.opts.zoomOpacity) && (a = .1 < Math.abs(u.width / u.height - c.width / c.height)),
                a && (c.opacity = 0),
                g.fancybox.setTranslate(r, l),
                f(r),
                g.fancybox.animate(r, c, o, n)) : i && o ? g.fancybox.animate(u.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + i, o, n) : !0 === t ? setTimeout(n, o) : n(),
                !0))
            },
            cleanUp: function(t) {
                ...
                o.current = null,
                (e = g.fancybox.getInstance()) ? e.activate() : (g("body").removeClass("fancybox-active compensate-for-scrollbar"),
            ...
            trigger: function(t, e) {
                ...
                i.unshift(o),
                g.isFunction(r.opts[t]) && (n = r.opts[t].apply(r, i)),
                !1 === n)
                    return n;
            ...
            updateControls: function() {
                ...
                r && r.length ? (t.$caption = o).children().eq(0).html(r) : t.$caption = null,
                ...
                "image" === e.type ? i.find("[data-fancybox-zoom]").show().end().find("[data-fancybox-download]").attr("href", e.opts.image.src || e.src).show() : e.opts.toolbar && i.find("[data-fancybox-download],[data-fancybox-zoom]").hide(),
                g(c.activeElement).is(":hidden,[disabled]") && t.$refs.container.trigger("focus")
            },
            ...
            showControls: function() {
                ...
                n.toggleClass("fancybox-show-toolbar", !(!e.toolbar || !e.buttons)).toggleClass("fancybox-show-infobar", !!(e.infobar && 1 < t.group.length)).toggleClass("fancybox-show-caption", !!t.$caption).toggleClass("fancybox-show-nav", !!(e.arrows && 1 < t.group.length)).toggleClass("fancybox-is-modal", !!e.modal)
            },
        ...
        g.fancybox = {
            ...
            use3d: (p = c.createElement("div"),
            l.getComputedStyle && l.getComputedStyle(p) && l.getComputedStyle(p).getPropertyValue("transform") && !(c.documentMode && c.documentMode < 11)),
            ...
            animate: function(e, n, i, o, r) {
                ...
                e.on(d, function(t) {
                    ...
                    g.isPlainObject(n) ? void 0 !== n.scaleX && void 0 !== n.scaleY && a.setTranslate(e, {
                        top: n.top,
                        left: n.left,
                ...
                g.isPlainObject(n) ? (void 0 !== n.scaleX && void 0 !== n.scaleY && (delete n.width,
                delete n.height,
        ...
        s.on("mousedown mouseup focus blur", ".fancybox-button", function(t) {
            ...
            case "focusin":
                ...
                g(this).is(a) || g(this).is("[disabled]") || g(this).addClass("fancybox-focus");
                break;
            case "focusout":
                g(".fancybox-button").removeClass("fancybox-focus")
            }
...
function(f) {
    ...
    f(document).on("objectNeedsType.fb", function(t, e, o) {
        ...
        f.each(n, function(t, e) {
            if (s = u.match(e.matcher)) {
                ...
                return a = f.extend(!0, {}, e.params, o.opts[t], c),
                u = "function" === f.type(e.url) ? e.url.call(this, s, a, o) : p(e.url, s, a),
                r = "function" === f.type(e.thumb) ? e.thumb.call(this, s, a, o) : p(e.thumb, s),
                "youtube" === t ? u = u.replace(/&t=((\d+)m)?(\d+)s/, function(t, e, n, i) {
                    return "&start=" + ((n ? 60 * parseInt(n, 10) : 0) + parseInt(i, 10))
                }) : "vimeo" === t && (u = u.replace("&%23", "#")),
                !1
            }
        }),
        h ? (o.opts.thumb || o.opts.$thumb && o.opts.$thumb.length || (o.opts.thumb = r),
        "iframe" === h && (o.opts = f.extend(!0, o.opts, {
            iframe: {
                preload: !1,
                attr: {
                    scrolling: "no"
    ...
    var o = {
        ...
        load: function(t) {
            ...
            (e = f.fancybox.getInstance()) && (n = e.current.$content.find("iframe"),
...
function(g, l, m) {
    ...
    function c(t) {
        if (t.is('a,area,button,[role="button"],input,label,select,summary,textarea,video,audio,iframe') || m.isFunction(t.get(0).onclick) || t.data("selectable"))
            return !0;
    ...
    function u(t) {
        ...
        !(e = r || s)) && ((t = t.parent()).length && !t.hasClass("fancybox-stage") && !t.is("body")); )
            ;
        var n, i, o, r, s;
        return e
    }
    ...
    n.prototype.ontouchstart = function(t) {
        ...
        (!t.originalEvent || 2 != t.originalEvent.button) && r.length && n.length && !c(n) && !c(n.parent()) && (n.is("img") || !(t.originalEvent.clientX > n[0].clientWidth + n.offset().left))) {
            if (!o || i.isAnimating || o.$slide.hasClass("fancybox-animated"))
                return t.stopPropagation(),
                void t.preventDefault();
            e.realPoints = e.startPoints = d(t),
            e.startPoints.length && (o.touch && t.stopPropagation(),
            e.startEvent = t,
            e.canTap = !0,
            e.$target = n,
            e.$content = s,
            ...
            e.canvasWidth = Math.round(r[0].clientWidth),
            e.canvasHeight = Math.round(r[0].clientHeight),
            e.contentLastPos = null,
            e.contentStartPos = m.fancybox.getTranslate(e.$content) || {
                top: 0,
                left: 0
            },
            e.sliderStartPos = m.fancybox.getTranslate(r),
            ...
            m.fancybox.isMobile && l.addEventListener("scroll", e.onscroll, !0),
            ((e.opts || e.canPan) && (n.is(e.$stage) || e.$stage.find(n).length) || (n.is(".fancybox-image") && t.preventDefault(),
            m.fancybox.isMobile && n.parents(".fancybox-caption").length)) && (e.isScrollable = u(n) || u(n.parent()),
            m.fancybox.isMobile && e.isScrollable || t.preventDefault(),
            1 !== e.startPoints.length && !o.hasError || (e.canPan ? (m.fancybox.stop(e.$content),
    ...
    n.prototype.onSwipe = function(t) {
        ...
        if (!0 !== n)
            ...
            if (o.canTap = !1,
            r.group.length < 2 && o.opts.vertical ? o.isSwiping = "y" : r.isDragging || !1 === o.opts.vertical || "auto" === o.opts.vertical && 800 < m(g).width() ? o.isSwiping = "x" : (e = Math.abs(180 * Math.atan2(o.distanceY, o.distanceX) / Math.PI),
            ...
            m.each(r.slides, function(t, e) {
                var n, i;
                m.fancybox.stop(e.$slide),
                n = m.fancybox.getTranslate(e.$slide),
                i = m.fancybox.getTranslate(r.$refs.stage),
                e.$slide.css({
                    transform: "",
                    opacity: "",
                    "transition-duration": ""
                ...
                e.pos === r.current.pos && (o.sliderStartPos.top = n.top - i.top,
    ...
    n.prototype.onPan = function() {
        var t = this;
        v(t.newPoints[0], t.realPoints[0]) < (m.fancybox.isMobile ? 10 : 5) ? t.startPoints = t.newPoints : (t.canTap = !1,
    ...
    n.prototype.limitMovement = function() {
        var t, e, n, i, o, r, s = this, a = s.canvasWidth, l = s.canvasHeight, c = s.distanceX, d = s.distanceY, u = s.contentStartPos, h = u.left, f = u.top, p = u.width, g = u.height;
        return o = a < p ? h + c : h,
        r = f + d,
        ...
        0 < d && e < r && (r = e - 1 + Math.pow(-e + f + d, .8) || 0),
    ...
    n.prototype.ontouchend = function(t) {
        ...
        i ? e.endPanning() : o ? e.endZooming() : e.endSwiping(n, r)
    }
    ,
    n.prototype.endSwiping = function(t, e) {
        ...
        i = n.instance.close(!0, 250)) : s && 0 < n.distanceX ? i = n.instance.previous(300) : s && n.distanceX < 0 && (i = n.instance.next(300)),
    ...
    n.prototype.endPanning = function() {
        ...
        i.contentLastPos.top) : (t = i.contentLastPos.left + 500 * i.velocityX,
    ...
    n.prototype.endZooming = function() {
        ...
        s < o.canvasWidth && a < o.canvasHeight ? o.instance.scaleToFit(150) : s > r.width || a > r.height ? o.instance.scaleToActual(o.centerPointStartX, o.centerPointStartY, 150) : (n = o.limitPosition(t, e, s, a),
    ...
    n.prototype.onTap = function(n) {
        function t(t) {
            var e = s.opts[t];
            if (m.isFunction(e) && (e = e.apply(r, [s, n])),
            e)
                switch (e) {
                case "close":
        ...
        var e, i = this, o = m(n.target), r = i.instance, s = r.current, a = n && d(n) || i.startPoints, l = a[0] ? a[0].x - m(g).scrollLeft() - i.stagePos.left : 0, c = a[0] ? a[0].y - m(g).scrollTop() - i.stagePos.top : 0;
        if ((!n.originalEvent || 2 != n.originalEvent.button) && (o.is("img") || !(l > o[0].clientWidth + o.offset().left))) {
            ...
            if (i.tapped) {
                ...
                i.tapX = l,
                i.tapY = c,
                s.opts["dblclick" + e] && s.opts["dblclick" + e] !== s.opts["click" + e] ? i.tapped = setTimeout(function() {
                    i.tapped = null,
                    r.isAnimating || t("click" + e)
                }, 500) : t("click" + e);
            return this
        }
    }
...
function(t, r) {
    ...
    r.extend(i.prototype, {
        ...
        create: function() {
            ...
            t.$grid || (t.$grid = r('<div class="' + s + " " + s + "-" + t.opts.axis + '"></div>').appendTo(e.$refs.container.find(i).addBack().filter(i)),
            t.$grid.on("click", "a", function() {
                e.jumpTo(r(this).attr("data-index"))
            })),
            t.$list || (t.$list = r('<div class="' + s + '__list">').appendTo(t.$grid)),
            r.each(e.group, function(t, e) {
...
function(t, o) {
    ...
    o(t).on("click", "[data-fancybox-share]", function() {
        ...
        i && ("function" === o.type(i.opts.share.url) && (t = i.opts.share.url.apply(i, [n, i])),
        e = i.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === i.type ? encodeURIComponent(i.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(t)).replace(/\{\{url_raw\}\}/g, function(t) {
            var e = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
    ...
    o(function() {
        !1 !== o.fancybox.defaults.hash && (o(s).on({
            ...
            "beforeShow.fb": function(t, e, n, i) {
                ...
                r.location.hash !== "#" + e.currentHash && (i && !e.origHash && (e.origHash = r.location.hash),
            ...
            "beforeClose.fb": function(t, e, n) {
                n && !1 !== n.opts.hash && (clearTimeout(e.hashTimer),
        ...
        o(r).on("hashchange.fb", function() {
            ...
            i ? i.currentHash === t.gallery + "-" + t.index || 1 === t.index && i.currentHash == t.gallery || (i.currentHash = null,
...
function(n) {
    ...
    function r(t) {
        ...
        M(t.target).closest("form").ajaxSubmit(e))
    }
    function s(t) {
        var e = t.target
          , n = M(e);
        ...
        if ("image" === (o.clk = e).type)
            if (void 0 !== t.offsetX)
                ...
                var r = n.offset();
                o.clk_x = t.pageX - r.left,
                o.clk_y = t.pageY - r.top
            } else
                o.clk_x = t.pageX - e.offsetLeft,
                o.clk_y = t.pageY - e.offsetTop;
        setTimeout(function() {
    ...
    var f = /\r?\n/g
      , T = {};
    T.fileapi = void 0 !== M('<input type="file">').get(0).files,
    ...
    M.fn.ajaxSubmit = function(D, t, e, n) {
        function i(t) {
            function d(e) {
                ...
                try {
                    ...
                    H("cannot get iframe.contentDocument: " + t),
                    n = e.document
                }
                return n
            }
            function e() {
                ...
                L && !/post/i.test(L) || a.setAttribute("method", "POST"),
                e !== h.url && a.setAttribute("action", h.url),
                h.skipEncodingOverride || L && !/post/i.test(L) || P.attr({
                ...
                try {
                    if (h.extraData)
                        for (var o in h.extraData)
                            h.extraData.hasOwnProperty(o) && (M.isPlainObject(h.extraData[o]) && h.extraData[o].hasOwnProperty("name") && h.extraData[o].hasOwnProperty("value") ? i.push(M('<input type="hidden" name="' + h.extraData[o].name + '">', l).val(h.extraData[o].value).appendTo(a)[0]) : i.push(M('<input type="hidden" name="' + o + '">', l).val(h.extraData[o]).appendTo(a)[0]));
                    h.iframeTarget || p.appendTo(c),
                    g.attachEvent ? g.attachEvent("onload", u) : g.addEventListener("load", u, !1),
                    ...
                    t ? a.setAttribute("target", t) : P.removeAttr("target"),
                    M(i).remove()
                }
            }
            function u(t) {
                if (!m.aborted && !E) {
                    if ((C = d(g)) || (H("cannot access response document"),
                    t = x),
                    t === w && m)
                        return m.abort("timeout"),
                        void y.reject(m, "timeout");
                    if (t === x && m)
                        return m.abort("server abort"),
                        void y.reject(m, "error", "server abort");
                    if (C && C.location.href !== h.iframeSrc || v) {
                        ...
                        try {
                            ...
                            if (H("isXml=" + i),
                            !i && window.opera && (null === C.body || !C.body.innerHTML) && --k)
                                return H("requeing onLoad callback, DOM not available"),
                                void setTimeout(u, 250);
                            var o = C.body ? C.body : C.documentElement;
                            m.responseText = o ? o.innerHTML : null,
                            m.responseXML = C.XMLDocument ? C.XMLDocument : C,
                            i && (h.dataType = "xml"),
                            ...
                            ,
                            o && (m.status = Number(o.getAttribute("status")) || m.status,
                            ...
                            if (s || h.textarea) {
                                ...
                                "xml" === r && !m.responseXML && m.responseText && (m.responseXML = $(m.responseText));
                            try {
                                _ = I(m, r, h)
                            } catch (t) {
                                n = "parsererror",
                        ...
                        m.aborted && (H("upload aborted"),
                        n = null),
                        m.status && (n = 200 <= m.status && m.status < 300 || 304 === m.status ? "success" : "error"),
                        "success" === n ? (h.success && h.success.call(h.context, _, "success", m),
                        y.resolve(m.responseText, "success", m),
                        f && M.event.trigger("ajaxSuccess", [m, h])) : n && (void 0 === e && (e = m.statusText),
                        h.error && h.error.call(h.context, m, n, e),
                        y.reject(m, "error", e),
                        f && M.event.trigger("ajaxError", [m, h, e])),
                        f && M.event.trigger("ajaxComplete", [m, h]),
                        f && !--M.active && M.event.trigger("ajaxStop"),
                        h.complete && h.complete.call(h.context, m, n),
                        E = !0,
                        h.timeout && clearTimeout(b),
                        setTimeout(function() {
                            h.iframeTarget ? p.attr("src", h.iframeSrc) : p.remove(),
                            m.responseXML = null
                        }, 100)
                    }
                }
            }
            var n, i, h, f, r, p, g, m, o, s, v, b, a = P[0], y = M.Deferred();
            ...
            t)
                for (i = 0; i < O.length; i++)
                    n = M(O[i]),
                    j ? n.prop("disabled", !1) : n.removeAttr("disabled");
            (h = M.extend(!0, {}, M.ajaxSettings, D)).context = h.context || h,
            ...
            m = {
                ...
                abort: function(t) {
                    ...
                    p.attr("src", h.iframeSrc),
                    m.error = e,
                    h.error && h.error.call(h.context, m, e, t),
                    f && M.event.trigger("ajaxError", [m, h, e]),
                    h.complete && h.complete.call(h.context, m, e)
                }
            },
            (f = h.global) && 0 == M.active++ && M.event.trigger("ajaxStart"),
            f && M.event.trigger("ajaxSend", [m, h]),
            h.beforeSend && !1 === h.beforeSend.call(h.context, m, h))
                return h.global && M.active--,
                y.reject(),
                y;
            if (m.aborted)
                return y.reject(),
                y;
            (o = a.clk) && (s = o.name) && !o.disabled && (h.extraData = h.extraData || {},
            h.extraData[s] = o.value,
            "image" === o.type && (h.extraData[s + ".x"] = a.clk_x,
            h.extraData[s + ".y"] = a.clk_y));
            var w = 1
              , x = 2
              , S = M("meta[name=csrf-token]").attr("content")
              , T = M("meta[name=csrf-param]").attr("content");
            T && S && (h.extraData = h.extraData || {},
            h.extraData[T] = S),
            h.forceSync ? e() : setTimeout(e, 10);
            var _, C, E, k = 50, $ = M.parseXML || function(t, e) {
            ...
            , I = function(t, e, n) {
                ...
                return o && "parsererror" === r.documentElement.nodeName && M.error && M.error("parsererror"),
                n && n.dataFilter && (r = n.dataFilter(r, e)),
                "string" == typeof r && (("json" === e || !e) && 0 <= i.indexOf("json") ? r = A(r) : ("script" === e || !e) && 0 <= i.indexOf("javascript") && M.globalEval(r)),
                r
            };
            return y
        }
        if (!this.length)
            return H("ajaxSubmit: skipping submit process - no element selected"),
            this;
        var L, o, r, P = this;
        "function" == typeof D ? D = {
            success: D
        ...
        "function" == typeof n && (D.success = n)) : void 0 === D && (D = {}),
        L = D.method || D.type || this.attr2("method"),
        (r = (r = "string" == typeof (o = D.url || this.attr2("action")) ? M.trim(o) : "") || window.location.href || "") && (r = (r.match(/^([^#]+)/) || [])[1]),
        D = M.extend(!0, {
            url: r,
        ...
        var s = {};
        if (this.trigger("form-pre-serialize", [this, D, s]),
        s.veto)
            return H("ajaxSubmit: submit vetoed via form-pre-serialize trigger"),
            this;
        if (D.beforeSerialize && !1 === D.beforeSerialize(this, D))
            return H("ajaxSubmit: submit aborted via beforeSerialize callback"),
            this;
        var a = D.traditional;
        ...
        if (D.beforeSubmit && !1 === D.beforeSubmit(c, this, D))
            return H("ajaxSubmit: submit aborted via beforeSubmit callback"),
            this;
        if (this.trigger("form-submit-validate", [c, this, D, s]),
        s.veto)
            return H("ajaxSubmit: submit vetoed via form-submit-validate trigger"),
            this;
        var u = M.param(c, a);
        l && (u = u ? u + "&" + l : l),
        "GET" === D.type.toUpperCase() ? (D.url += (0 <= D.url.indexOf("?") ? "&" : "?") + u,
        D.data = null) : D.data = u;
        var h = [];
        ...
        !D.dataType && D.target) {
            ...
            D.success && (M.isArray(D.success) ? M.merge(h, D.success) : h.push(D.success));
        if (D.success = function(t, e, n) {
            for (var i = D.context || this, o = 0, r = h.length; o < r; o++)
                h[o].apply(i, [t, e, n || P, P])
        }
        ,
        D.error) {
            var p = D.error;
        ...
        !1 !== D.iframe && (D.iframe || x) ? D.closeKeepAlive ? M.get(D.closeKeepAlive, function() {
            ...
            if (D.extraData) {
                var i = function(t) {
                    var e, n, i = M.param(t, D.traditional).split("&"), o = i.length, r = [];
                    for (e = 0; e < o; e++)
                        i[e] = i[e].replace(/\+/g, " "),
                        n = i[e].split("="),
            ...
            D.uploadProgress && (o.xhr = function() {
                ...
                return t.upload && t.upload.addEventListener("progress", function(t) {
                    var e = 0
                      ...
                      , i = t.total;
                    t.lengthComputable && (e = Math.ceil(n / i * 100)),
                    D.uploadProgress(t, n, i, e)
                }, !1),
                t
            }
            ),
            ...
            return o.beforeSend = function(t, e) {
                D.formData ? e.data = D.formData : e.data = n,
                r && r.call(this, t, e)
            }
            ,
            M.ajax(o)
        ...
        for (var S = 0; S < O.length; S++)
            O[S] = null;
        return this.trigger("form-submit-notify", [this, D]),
        this
    }
    ,
    M.fn.ajaxForm = function(t, e, n, i) {
        ...
        "function" == typeof i && (t.success = i)),
        (t = t || {}).delegation = t.delegation && M.isFunction(M.fn.on),
        t.delegation || 0 !== this.length)
            return t.delegation ? (M(document).off("submit.form-plugin", this.selector, r).off("click.form-plugin", this.selector, s).on("submit.form-plugin", this.selector, t, r).on("click.form-plugin", this.selector, t, s),
            this) : this.ajaxFormUnbind().on("submit.form-plugin", t, r).on("click.form-plugin", t, s);
        var o = {
            s: this.selector,
            c: this.context
        };
        return !M.isReady && o.s ? (H("DOM not ready, queuing ajaxForm"),
        M(function() {
            M(o.s, o.c).ajaxForm(t)
        })) : H("terminating; zero elements found by selector" + (M.isReady ? "" : " (DOM not ready)")),
        this
    }
    ,
    ...
    M.fn.formToArray = function(t, e, n) {
        ...
        if (0 === this.length)
            return i;
        var o, r, s, a, l, c, d, u, h = this[0], f = this.attr("id"), p = t || void 0 === h.elements ? h.getElementsByTagName("*") : h.elements;
        if (p = p && M.makeArray(p),
        f && (t || /(Edge|Trident)\//.test(navigator.userAgent)) && (o = M(':input[form="' + f + '"]').get()).length && (p = (p || []).concat(o)),
        !p || !p.length)
            return i;
        for (M.isFunction(n) && (p = M.map(p, n)),
        r = 0,
        d = p.length; r < d; r++)
            if ((a = (c = p[r]).name) && !c.disabled)
                if (t && h.clk && "image" === c.type)
                    h.clk === c && (i.push({
                        name: a,
                        value: M(c).val(),
                        type: c.type
    ...
    M.fieldValue = function(t, e) {
        ...
        for (var s = [], a = t.options, l = "select-one" === i, c = l ? r + 1 : a.length, d = l ? r : 0; d < c; d++) {
            ...
            if (u.selected && !u.disabled) {
                var h = u.value;
                if (h = h || (u.attributes && u.attributes.value && !u.attributes.value.specified ? u.text : u.value),
                l)
                    return h;
                s.push(h)
            }
    ...
    M.fn.resetForm = function() {
        return this.each(function() {
            ...
            case "form":
                ...
                !0;
            default:
                return e.find("form,input,label,select,textarea").resetForm(),
                !0
            }
        })
    }
    ...
    M.fn.selected = function(n) {
        ...
        this.each(function() {
            ...
            if ("checkbox" === t || "radio" === t)
                ...
                n && e[0] && "select-one" === e[0].type && e.find("option").selected(!1),
                this.selected = n
            }
        })
    }
...
function(t) {
    ...
    d.extend(d.fn, {
        validate: function(t) {
            if (this.length) {
                ...
                this.on("submit.validate", function(n) {
                    function t() {
                        var t, e;
                        return i.submitButton && (i.settings.submitHandler || i.formSubmitted) && (t = d("<input type='hidden'/>").attr("name", i.submitButton.name).val(d(i.submitButton).val()).appendTo(i.currentForm)),
        ...
        valid: function() {
            var t, e, n;
            return d(this[0]).is("form") ? t = this.validate().form() : (n = [],
            t = !0,
        ...
        rules: function(t, e) {
            var n, i, o, r, s, a, l = this[0], c = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
            if (null != l && (!l.form && c && (l.form = this.closest("form")[0],
            l.name = this.attr("name")),
            null != l.form)) {
                if (t)
                    switch (n = d.data(l.form, "validator").settings,
                    i = n.rules,
                    o = d.validator.staticRules(l),
                    t) {
                    case "add":
                        d.extend(o, d.validator.normalizeRule(e)),
                        delete o.messages,
                        i[l.name] = o,
                        e.messages && (n.messages[l.name] = d.extend(n.messages[l.name], e.messages));
                        break;
                    case "remove":
                        return e ? (a = {},
                ...
                return (r = d.validator.normalizeRules(d.extend({}, d.validator.classRules(l), d.validator.attributeRules(l), d.validator.dataRules(l), d.validator.staticRules(l)), l)).required && (s = r.required,
                delete r.required,
                r = d.extend({
                    required: s
                }, r)),
    ...
    d.extend(d.validator, {
        ...
        prototype: {
            ...
            element: function(t) {
                var e, n, i = this.clean(t), o = this.validationTargetFor(i), r = this, s = !0;
                return void 0 === o ? delete this.invalid[i.name] : (this.prepareElement(o),
                this.currentElements = d(o),
                (n = this.groups[o.name]) && d.each(this.groups, function(t, e) {
                    e === n && t !== o.name && ((i = r.validationTargetFor(r.clean(r.findByName(t)))) && i.name in r.invalid && (r.currentElements.push(i),
                    s = r.check(i) && s))
                }),
                e = !1 !== this.check(o),
                s = s && e,
            ...
            elements: function() {
                ...
                return d(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    this.name = t),
                    !(this.form !== n.currentForm || t in i || !n.objectLength(d(this).rules()) || (i[t] = !0,
                    0))
                })
            },
            clean: function(t) {
            ...
            elementValue: function(t) {
                var e, n, i = d(t), o = t.type, r = void 0 !== i.attr("contenteditable") && "false" !== i.attr("contenteditable");
                return "radio" === o || "checkbox" === o ? this.findByName(t.name).filter(":checked").val() : "number" === o && void 0 !== t.validity ? t.validity.badInput ? "NaN" : i.val() : (e = r ? i.text() : i.val(),
                "file" === o ? "C:\\fakepath\\" === e.substr(0, 12) ? e.substr(12) : 0 <= (n = e.lastIndexOf("/")) ? e.substr(n + 1) : 0 <= (n = e.lastIndexOf("\\")) ? e.substr(n + 1) : e : "string" == typeof e ? e.replace(/\r/g, "") : e)
            },
            check: function(e) {
                e = this.validationTargetFor(this.clean(e));
                var t, n, i, o, r = d(e).rules(), s = d.map(r, function(t, e) {
                    return e
                }).length, a = !1, l = this.elementValue(e);
                for (n in "function" == typeof r.normalizer ? o = r.normalizer : "function" == typeof this.settings.normalizer && (o = this.settings.normalizer),
                o && (l = o.call(e, l),
                delete r.normalizer),
                r) {
                    i = {
            ...
            defaultMessage: function(t, e) {
                ...
                var n = this.findDefined(this.customMessage(t.name, e.method), this.customDataMessage(t, e.method), !this.settings.ignoreTitle && t.title || void 0, d.validator.messages[e.method], "<strong>Warning: No message defined for " + t.name + "</strong>")
                  , i = /\$?\{(\d+)\}/g;
                return "function" == typeof n ? n = n.call(this, e.parameters, t) : i.test(n) && (n = d.validator.format(n.replace(i, "{$1}"), e.parameters)),
                n
            },
            ...
            showLabel: function(t, e) {
                var n, i, o, r, s = this.errorsFor(t), a = this.idOrName(t), l = d(t).attr("aria-describedby");
                s.length ? (s.removeClass(this.settings.validClass).addClass(this.settings.errorClass),
                s.html(e)) : (n = s = d("<" + this.settings.errorElement + ">").attr("id", a + "-error").addClass(this.settings.errorClass).html(e || ""),
                this.settings.wrapper && (n = s.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()),
                this.labelContainer.length ? this.labelContainer.append(n) : this.settings.errorPlacement ? this.settings.errorPlacement.call(this, n, d(t)) : n.insertAfter(t),
        ...
        attributeRules: function(t) {
            var e, n, i = {}, o = d(t), r = t.getAttribute("type");
            for (e in d.validator.methods)
                n = "required" === e ? ("" === (n = t.getAttribute(e)) && (n = !0),
                !!n) : o.attr(e),
        ...
        dataRules: function(t) {
            var e, n, i = {}, o = d(t), r = t.getAttribute("type");
            for (e in d.validator.methods)
                "" === (n = o.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase())) && (n = !0),
                this.normalizeAttributeRule(i, r, e, n);
            return i
        },
        staticRules: function(t) {
            ...
            return n.settings.rules && (e = d.validator.normalizeRule(n.settings.rules[t.name]) || {}),
            e
        },
        normalizeRules: function(i, o) {
            return d.each(i, function(t, e) {
                if (!1 !== e) {
                    if (e.param || e.depends) {
                        ...
                        n ? i[t] = void 0 === e.param || e.param : (d.data(o.form, "validator").resetElements(d(o)),
                        delete i[t])
                    }
                } else
                    delete i[t]
            ...
            d.each(["rangelength", "range"], function() {
                var t;
                i[this] && (d.isArray(i[this]) ? i[this] = [Number(i[this][0]), Number(i[this][1])] : "string" == typeof i[this] && (t = i[this].replace(/[\[\]]/g, "").split(/[\s,]+/),
        ...
        addMethod: function(t, e, n) {
            ...
            d.validator.messages[t] = void 0 !== n ? n : d.validator.messages[t],
        ...
        methods: {
            ...
            step: function(t, e, n) {
                ...
                var r, s = d(e).attr("type"), a = "Step attribute on input type " + s + " is not supported.", l = new RegExp("\\b" + s + "\\b"), c = !0;
            ...
            remote: function(r, s, t, a) {
                ...
                c.originalMessage = c.originalMessage || this.settings.messages[s.name][a],
                this.settings.messages[s.name][a] = c.message,
                t = "string" == typeof t && {
                    url: t
                } || t,
                n = d.param(d.extend({
                ...
                d.ajax(d.extend(!0, {
                    ...
                    success: function(t) {
                        ...
                        l.settings.messages[s.name][a] = c.originalMessage,
                        o ? (i = l.formSubmitted,
                        l.resetInternals(),
                        ...
                        l.invalid[s.name] = !1,
                        l.showErrors()) : (e = {},
                        n = t || l.defaultMessage(s, {
                            method: a,
                            parameters: r
                        }),
                        e[s.name] = c.message = n,
                        l.invalid[s.name] = !0,
                        l.showErrors(e)),
                        c.valid = o,
                        l.stopRequest(s, o)
    ...
    d.ajax = function(t) {
        ...
        return "abort" === e ? (o[n] && o[n].abort(),
        o[n] = i.apply(this, arguments),
        o[n]) : i.apply(this, arguments)
    }
    ),
    d
...
function r(s, a, l) {
    ...
    3: [function(t, e, n) {
        ...
        i.prototype.unbind = function(e, n) {
            ...
            this.events[e] = this.events[e].filter(function(t) {
                return !(!i || t === n) || (this.element.removeEventListener(e, t, !1),
                !1)
            }, this)
        }
        ,
    ...
    9: [function(t, e, n) {
        ...
        e.exports = function(t) {
            !function(n, i) {
                ...
                i.event.bind(i.scrollbarY, "click", t),
                i.event.bind(i.scrollbarYRail, "click", function(t) {
                    var e = t.pageY - window.pageYOffset - o(i.scrollbarYRail).top > i.scrollbarYTop ? 1 : -1;
                    s(n, "top", n.scrollTop + e * i.containerHeight),
                    r(n),
                    t.stopPropagation()
                }),
                i.event.bind(i.scrollbarX, "click", t),
                i.event.bind(i.scrollbarXRail, "click", function(t) {
                    var e = t.pageX - window.pageXOffset - o(i.scrollbarXRail).left > i.scrollbarXLeft ? 1 : -1;
                    s(n, "left", n.scrollLeft + e * i.containerWidth),
                    r(n),
                    t.stopPropagation()
                })
            }(t, i.get(t))
    ...
    10: [function(t, e, n) {
        ...
        function i(o, r) {
            ...
            function n() {
                a.stopScrolling(o, "x"),
                r.event.unbind(r.ownerDocument, "mousemove", e)
            }
            var s = null
              , i = null;
            r.event.bind(r.scrollbarX, "mousedown", function(t) {
                i = t.pageX,
                s = a.toInt(l.css(r.scrollbarX, "left")) * r.railXRatio,
                a.startScrolling(o, "x"),
                r.event.bind(r.ownerDocument, "mousemove", e),
                r.event.once(r.ownerDocument, "mouseup", n),
                t.stopPropagation(),
                t.preventDefault()
            })
        }
        function o(o, r) {
            ...
            r.event.bind(r.scrollbarY, "mousedown", function(t) {
                i = t.pageY,
                s = a.toInt(l.css(r.scrollbarY, "top")) * r.railYRatio,
                a.startScrolling(o, "y"),
                r.event.bind(r.ownerDocument, "mousemove", e),
                r.event.once(r.ownerDocument, "mouseup", n),
                t.stopPropagation(),
                t.preventDefault()
            ...
            s.event.bind(s.ownerDocument, "keydown", function(t) {
                if (!(t.isDefaultPrevented && t.isDefaultPrevented() || t.defaultPrevented)) {
                    ...
                    if (a || e) {
                        ...
                        u(r, "top", r.scrollTop - o),
                        u(r, "left", r.scrollLeft + i),
                        d(r),
                        function(t, e) {
                            var n = r.scrollTop;
                            if (0 === t) {
                                if (!s.scrollbarYActive)
                                    return !1;
                                if (0 === n && 0 < e || n >= s.contentHeight - s.containerHeight && e < 0)
                            ...
                            if (0 === e) {
                                if (!s.scrollbarXActive)
                                    return !1;
                                if (0 === i && t < 0 || i >= s.contentWidth - s.containerWidth && 0 < t)
                                    return !s.settings.wheelPropagation
                            }
                            return !0
            ...
            function t(t) {
                ...
                !function(t, e) {
                    ...
                    if (n) {
                        ...
                        if (0 < o && !(0 === n.scrollTop && 0 < e || n.scrollTop === o && e < 0))
                            return !0;
                        var r = n.scrollLeft - n.clientWidth;
                        if (0 < r && !(0 === n.scrollLeft && t < 0 || n.scrollLeft === r && 0 < t))
                            return !0
                    }
                    return !1
                }(n, i) && (r = !1,
                o.settings.useBothWheelAxes ? o.scrollbarYActive && !o.scrollbarXActive ? (l(s, "top", i ? s.scrollTop - i * o.settings.wheelSpeed : s.scrollTop + n * o.settings.wheelSpeed),
                r = !0) : o.scrollbarXActive && !o.scrollbarYActive && (l(s, "left", n ? s.scrollLeft + n * o.settings.wheelSpeed : s.scrollLeft - i * o.settings.wheelSpeed),
                r = !0) : (l(s, "top", s.scrollTop - i * o.settings.wheelSpeed),
                l(s, "left", s.scrollLeft + n * o.settings.wheelSpeed)),
                a(s),
                (r = r || function(t, e) {
                    var n = s.scrollTop;
                    if (0 === t) {
                        if (!o.scrollbarYActive)
                            return !1;
                        if (0 === n && 0 < e || n >= o.contentHeight - o.containerHeight && e < 0)
                    ...
                    if (0 === e) {
                        if (!o.scrollbarXActive)
                            return !1;
                        if (0 === i && t < 0 || i >= o.contentWidth - o.containerWidth && 0 < t)
                            return !o.settings.wheelPropagation
                    }
                    return !0
        ...
        function i(a, t) {
            ...
            t.event.bind(window, "mousemove", function(t) {
                if (u) {
                    ...
                    e < i + 3 ? (d.left = -5,
                    h.startScrolling(a, "x")) : o - 3 < e ? (d.left = 5,
                    h.startScrolling(a, "x")) : d.left = 0,
                    n < r + 3 ? (d.top = r + 3 - n < 5 ? -5 : -20,
                    h.startScrolling(a, "y")) : s - 3 < n ? (d.top = n - s + 3 < 5 ? 5 : 20,
                    h.startScrolling(a, "y")) : d.top = 0,
                    0 === d.top && 0 === d.left ? l() : c = c || setInterval(function() {
                        return f.get(a) ? (g(a, "top", a.scrollTop + d.top),
                        g(a, "left", a.scrollLeft + d.left),
                        void p(a)) : void clearInterval(c)
                    }, 50)
                }
            })
        }
    ...
    15: [function(t, e, n) {
        ...
        function i(a, l, t, e) {
            function c(t, e) {
                w(a, "top", a.scrollTop - e),
                w(a, "left", a.scrollLeft - t),
                y(a)
            }
            function n() {
                m = !0
            ...
            function o(t) {
                if (!v && l.settings.swipePropagation && h(t),
                !m && v && u(t)) {
                    var e = d(t)
                      , n = {
                        pageX: e.pageX,
                    ...
                    function(t, e) {
                        var n = a.scrollTop
                          ...
                          , r = Math.abs(e);
                        if (o < r) {
                            if (e < 0 && n === l.contentHeight - l.containerHeight || 0 < e && 0 === n)
                                return !l.settings.swipePropagation
                        } else if (r < o && (t < 0 && i === l.contentWidth - l.containerWidth || 0 < t && 0 === i))
                            return !l.settings.swipePropagation;
                        return !0
                    }(i, o) && (t.stopPropagation(),
                    t.preventDefault())
                }
            }
            function r() {
                !m && v && (v = !1,
                l.settings.swipeEasing && (clearInterval(s),
                s = setInterval(function() {
                    return b.get(a) && (g.x || g.y) ? Math.abs(g.x) < .01 && Math.abs(g.y) < .01 ? void clearInterval(s) : (c(30 * g.x, 30 * g.y),
                    g.x *= .8,
                    void (g.y *= .8)) : void clearInterval(s)
                }, 10)))
            }
            var f = {}
              , p = 0
              ...
              , m = !1
              , v = !1;
            t ? (l.event.bind(window, "touchstart", n),
            l.event.bind(window, "touchend", i),
            l.event.bind(a, "touchstart", h),
            l.event.bind(a, "touchmove", o),
            l.event.bind(a, "touchend", r)) : e && (window.PointerEvent ? (l.event.bind(window, "pointerdown", n),
            l.event.bind(window, "pointerup", i),
            l.event.bind(a, "pointerdown", h),
            l.event.bind(a, "pointermove", o),
            l.event.bind(a, "pointerup", r)) : window.MSPointerEvent && (l.event.bind(window, "MSPointerDown", n),
            l.event.bind(window, "MSPointerUp", i),
            l.event.bind(a, "MSPointerDown", h),
            l.event.bind(a, "MSPointerMove", o),
            l.event.bind(a, "MSPointerUp", r)))
        }
        var o = t("../../lib/helper")
          , b = t("../instances")
          , y = t("../update-geometry")
    ...
    17: [function(t, e, n) {
        ...
        function i(t, e) {
            ...
            s.isRtl = "rtl" === d.css(t, "direction"),
            s.isNegativeScroll = (r = t.scrollLeft,
            t.scrollLeft = -1,
            o = t.scrollLeft < 0,
            t.scrollLeft = r,
            o),
            ...
            s.scrollbarXRail = d.appendTo(d.create("div", "ps__scrollbar-x-rail"), t),
            s.scrollbarX = d.appendTo(d.create("div", "ps__scrollbar-x"), s.scrollbarXRail),
            s.scrollbarX.setAttribute("tabindex", 0),
            s.event.bind(s.scrollbarX, "focus", n),
            s.event.bind(s.scrollbarX, "blur", i),
            s.scrollbarXActive = null,
            s.scrollbarXWidth = null,
            s.scrollbarXLeft = null,
            s.scrollbarXBottom = l.toInt(d.css(s.scrollbarXRail, "bottom")),
            s.isScrollbarXUsingBottom = s.scrollbarXBottom == s.scrollbarXBottom,
            s.scrollbarXTop = s.isScrollbarXUsingBottom ? null : l.toInt(d.css(s.scrollbarXRail, "top")),
            s.railBorderXWidth = l.toInt(d.css(s.scrollbarXRail, "borderLeftWidth")) + l.toInt(d.css(s.scrollbarXRail, "borderRightWidth")),
            d.css(s.scrollbarXRail, "display", "block"),
            s.railXMarginWidth = l.toInt(d.css(s.scrollbarXRail, "marginLeft")) + l.toInt(d.css(s.scrollbarXRail, "marginRight")),
            d.css(s.scrollbarXRail, "display", ""),
            s.railXWidth = null,
            s.railXRatio = null,
            s.scrollbarYRail = d.appendTo(d.create("div", "ps__scrollbar-y-rail"), t),
            s.scrollbarY = d.appendTo(d.create("div", "ps__scrollbar-y"), s.scrollbarYRail),
            s.scrollbarY.setAttribute("tabindex", 0),
            s.event.bind(s.scrollbarY, "focus", n),
            s.event.bind(s.scrollbarY, "blur", i),
            s.scrollbarYActive = null,
            s.scrollbarYHeight = null,
            s.scrollbarYTop = null,
            s.scrollbarYRight = l.toInt(d.css(s.scrollbarYRail, "right")),
            s.isScrollbarYUsingRight = s.scrollbarYRight == s.scrollbarYRight,
            s.scrollbarYLeft = s.isScrollbarYUsingRight ? null : l.toInt(d.css(s.scrollbarYRail, "left")),
            s.scrollbarYOuterWidth = s.isRtl ? l.outerWidth(s.scrollbarY) : null,
            s.railBorderYWidth = l.toInt(d.css(s.scrollbarYRail, "borderTopWidth")) + l.toInt(d.css(s.scrollbarYRail, "borderBottomWidth")),
            d.css(s.scrollbarYRail, "display", "block"),
            s.railYMarginHeight = l.toInt(d.css(s.scrollbarYRail, "marginTop")) + l.toInt(d.css(s.scrollbarYRail, "marginBottom")),
            d.css(s.scrollbarYRail, "display", ""),
            s.railYHeight = null,
            s.railYRatio = null
        }
        function o(t) {
    ...
    18: [function(t, e, n) {
        ...
        e.exports = function(t) {
            ...
            t.contains(n.scrollbarXRail) || (0 < (e = r.queryChildren(t, ".ps__scrollbar-x-rail")).length && e.forEach(function(t) {
                r.remove(t)
            }),
            r.appendTo(n.scrollbarXRail, t)),
            t.contains(n.scrollbarYRail) || (0 < (e = r.queryChildren(t, ".ps__scrollbar-y-rail")).length && e.forEach(function(t) {
                r.remove(t)
            }),
            r.appendTo(n.scrollbarYRail, t)),
            ...
            n.scrollbarXWidth = i(n, o.toInt(n.railXWidth * n.containerWidth / n.contentWidth)),
            n.scrollbarXLeft = o.toInt((n.negativeScrollAdjustment + t.scrollLeft) * (n.railXWidth - n.scrollbarXWidth) / (n.contentWidth - n.containerWidth))) : n.scrollbarXActive = !1,
            ...
            n.scrollbarYHeight = i(n, o.toInt(n.railYHeight * n.containerHeight / n.contentHeight)),
            n.scrollbarYTop = o.toInt(t.scrollTop * (n.railYHeight - n.scrollbarYHeight) / (n.contentHeight - n.containerHeight))) : n.scrollbarYActive = !1,
            ...
            n.scrollbarXActive ? t.classList.add("ps--active-x") : (t.classList.remove("ps--active-x"),
            n.scrollbarXWidth = 0,
            n.scrollbarXLeft = 0,
            a(t, "left", 0)),
            n.scrollbarYActive ? t.classList.add("ps--active-y") : (t.classList.remove("ps--active-y"),
    ...
    19: [function(t, e, n) {
        ...
        e.exports = function(t, e, n) {
            ...
            var i = r.get(t);
            "top" === e && n >= i.contentHeight - i.containerHeight && ((n = i.contentHeight - i.containerHeight) - t.scrollTop <= 2 ? n = t.scrollTop : t.scrollTop = n,
            t.dispatchEvent(o("ps-y-reach-end"))),
            "left" === e && n >= i.contentWidth - i.containerWidth && ((n = i.contentWidth - i.containerWidth) - t.scrollLeft <= 2 ? n = t.scrollLeft : t.scrollLeft = n,
            t.dispatchEvent(o("ps-x-reach-end"))),
            void 0 === i.lastTop && (i.lastTop = t.scrollTop),
            void 0 === i.lastLeft && (i.lastLeft = t.scrollLeft),
            "top" === e && n < i.lastTop && t.dispatchEvent(o("ps-scroll-up")),
            "top" === e && n > i.lastTop && t.dispatchEvent(o("ps-scroll-down")),
            "left" === e && n < i.lastLeft && t.dispatchEvent(o("ps-scroll-left")),
            "left" === e && n > i.lastLeft && t.dispatchEvent(o("ps-scroll-right")),
            "top" === e && n !== i.lastTop && (t.scrollTop = i.lastTop = n,
            t.dispatchEvent(o("ps-scroll-y"))),
            "left" === e && n !== i.lastLeft && (t.scrollLeft = i.lastLeft = n,
    ...
    20: [function(t, e, n) {
        ...
        e.exports = function(t) {
            ...
            e.railXMarginWidth = i.toInt(o.css(e.scrollbarXRail, "marginLeft")) + i.toInt(o.css(e.scrollbarXRail, "marginRight")),
            e.railYMarginHeight = i.toInt(o.css(e.scrollbarYRail, "marginTop")) + i.toInt(o.css(e.scrollbarYRail, "marginBottom")),
...
function(t, e) {
    ...
    function s(o, n) {
        ...
        function u(t) {
            var e = n ? n * t / 1e3 : t;
            return e = l < 1 ? Math.exp(-e * l * a) * (1 * Math.cos(c * e) + d * Math.sin(c * e)) : (1 + d * e) * Math.exp(-e * a),
            0 === t || 1 === t ? t : 1 - e
        }
        return n ? u : function() {
            var t = h.springs[o];
            ...
            return function(t) {
                return r === e && s === n ? t : 0 === t || 1 === t ? t : g(function(t) {
                    ...
                    return .001 <= o ? function(t, e, n, i) {
                        ...
                        for (var r, s, a = 0; 0 < (r = g(s = e + (n - e) / 2, i, o) - t) ? n = s : e = s,
                        1e-7 < Math.abs(r) && ++a < 10; )
                            ;
                        return s
                    }(t, e, e + .1, r, s)
                }(t), e, n)
    ...
    function b(t) {
        return k.arr(t) ? t : (k.str(t) && (t = v(t) || t),
    ...
    function H(t) {
        if (k.dom(t)) {
            for (var e, n = t.style.transform || "", i = /(\w+)\(([^)]*)\)/g, o = new Map; e = i.exec(n); )
                o.set(e[1], e[2]);
            return o
        }
    }
    function j(t, e, n, i) {
        ...
        case "transform":
            return function(t, e, n, i) {
                var o, r = a(e, "scale") ? 1 : 0 + (a(o = e, "translate") || "perspective" === o ? "px" : a(o, "rotate") || a(o, "skew") ? "deg" : void 0), s = H(t).get(e) || r;
                return n && (n.transforms.list.set(e, s),
                n.transforms.last = e),
                i ? P(t, s, i) : s
            }(t, e, i, n);
        case "css":
    ...
    function R(t, e) {
        if (k.col(t))
            return function(t) {
                ...
                "rgba(" + parseInt(o[1], 16) + "," + parseInt(o[2], 16) + "," + parseInt(o[3], 16) + ",1)") : k.hsl(t) ? function(t) {
                    var e, n, i, o = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(t) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(t), r = parseInt(o[1], 10) / 360, s = parseInt(o[2], 10) / 100, a = parseInt(o[3], 10) / 100, l = o[4] || 1;
                    function c(t, e, n) {
                        return n < 0 && (n += 1),
                        1 < n && (n -= 1),
    ...
    function z(t) {
        ...
        case "polygon":
            return n = (e = t).points,
            W(e) + F(n.getItem(n.numberOfItems - 1), n.getItem(0))
        }
        var e, n, i, o, r
    }
    function q(e, t) {
        var n = t || {}
          , i = n.el || function() {
            for (var t = e.parentNode; k.svg(t) && k.svg(t.parentNode); )
                t = t.parentNode;
            return t
        }()
    ...
    function V(t, i) {
        var e = w(i);
        if (/^spring/.test(e.easing) && (e.duration = s(e.easing)),
        k.arr(t)) {
            var n = t.length;
        ...
        return o.map(function(t, e) {
            ...
            return k.und(n.delay) && (n.delay = e ? 0 : i.delay),
            k.und(n.endDelay) && (n.endDelay = e === o.length - 1 ? i.endDelay : 0),
            n
        }).map(function(t) {
            return D(t, e)
        })
                    ...
                    if (n) {
                        var i = function(d, u) {
                            ...
                            return d.tweens.map(function(t) {
                                ...
                                e.easing = _(e.easing, e.duration),
                                e.isPath = k.pth(n),
                                e.isColor = k.col(e.from.original),
                                e.isColor && (e.round = 1),
                                h = e
                            })
                        }(e, t)
    ...
    function rt(t) {
        ...
        var e, n, i, o, h, f, p, g, _ = (n = I(T, e = t),
        o = function(t, e) {
            var n = []
              , i = e.keyframes;
        ...
        function m() {
            var t = _.direction;
            "alternate" !== t && (_.direction = "normal" !== t ? "normal" : "reverse"),
        ...
        function w(e) {
            for (var t = 0, n = _.animations, i = n.length; t < i; ) {
                ...
                for (var c = E(e - l.start - l.delay, 0, l.duration) / l.duration, d = isNaN(c) ? 1 : l.easing(c), u = l.to.strings, h = l.round, f = [], p = l.to.numbers.length, g = void 0, m = 0; m < p; m++) {
                    ...
                    v = l.isPath ? Y(l.value, d * b) : y + d * (b - y),
                    h && (l.isColor && 2 < m || (v = Math.round(v * h) / h)),
                    f.push(v)
                }
                var w = u.length;
                if (w) {
                    ...
                    g = f[0];
                K[o.type](r.target, o.property, g, r.transforms),
                o.currentValue = g,
                t++
            }
        }
        ...
        function S(t) {
            var e = _.duration
              ...
              , i = e - _.endDelay
              , o = v(t);
            _.progress = E(o / e * 100, 0, 100),
            _.reversePlayback = o < _.currentTime,
            r && function(t) {
            ...
            !_.began && 0 < _.currentTime && (_.began = !0,
            x("begin")),
            !_.loopBegan && 0 < _.currentTime && (_.loopBegan = !0,
            x("loopBegin")),
            o <= n && 0 !== _.currentTime && w(0),
            (i <= o && _.currentTime !== e || !e) && w(e),
            n < o && o < i ? (_.changeBegan || (_.changeBegan = !0,
            _.changeCompleted = !1,
            x("changeBegin")),
            x("change"),
            w(o)) : _.changeBegan && (_.changeCompleted = !0,
            _.changeBegan = !1,
            x("changeComplete")),
            _.currentTime = E(o, 0, e),
            _.began && x("update"),
            e <= t && (a = 0,
            ...
            x("loopComplete"),
            _.loopBegan = !1,
            "alternate" === _.direction && m()) : (_.paused = !0,
            _.completed || (_.completed = !0,
            x("loopComplete"),
            x("complete"),
            !_.passThrough && "Promise"in window && (d(),
            u(_)))))
        }
        return u(_),
        _.reset = function() {
            ...
            _.changeCompleted = !1,
            _.reversePlayback = !1,
            _.reversed = "reverse" === t,
            _.remaining = _.loop,
            r = _.children;
            for (var e = c = r.length; e--; )
                _.children[e].reset();
            (_.reversed && !0 !== _.loop || "alternate" === t && 1 === _.loop) && _.remaining++,
            w(_.reversed ? _.duration : 0)
        }
        ,
        _.set = function(t, e) {
            return Q(t, e),
    ...
    function st(t, e) {
        for (var n = e.length; n--; )
            y(t, e[n].animatable.target) && e.splice(n, 1)
    }
    return "undefined" != typeof document && document.addEventListener("visibilitychange", function() {
        ...
        t = et.slice(0),
        rt.running = et = []) : t.forEach(function(t) {
            return t.play()
        })
    }),
    rt.version = "3.1.0",
    ...
    rt.timeline = function(d) {
        ...
        u.add = function(t, e) {
            ...
            s.timelineOffset = k.und(e) ? a : N(e, a),
            o(u),
            u.seek(s.timelineOffset);
            var l = rt(s);
            o(l),
            i.push(l);
            var c = G(i, d);
            return u.delay = c.delay,
            u.endDelay = c.endDelay,
...
function(h) {
    ...
    h.instagramFeed = function(t) {
        ...
        if ("" == d.username && "" == d.tag)
            return console.error("Instagram Feed: Error, no username or tag found."),
            !1;
        if (void 0 !== d.get_raw_json && (console.warn("Instagram Feed: get_raw_json is deprecated. See use get_data instead"),
        d.get_data = d.get_raw_json),
        !d.get_data && "" == d.container)
            return console.error("Instagram Feed: Error, no container found."),
            !1;
        if (d.get_data && null == d.callback)
            return console.error("Instagram Feed: Error, no callback defined to get the raw json"),
            !1;
        var u = "" == d.username;
        return h.get(u ? d.host + "explore/tags/" + d.tag : d.host + d.username, function(t) {
            if (t = t.split("window._sharedData = ")[1].split("<\/script>")[0],
            t = (t = (t = JSON.parse(t.substr(0, t.length - 1))).entry_data.ProfilePage || t.entry_data.TagPage)[0].graphql.user || t[0].graphql.hashtag,
            d.get_data)
                d.callback(t);
            else {
                var e = ""
                  ...
                  , o = ""
                  , r = "";
                d.styling && (e = " style='text-align:center;'",
                n = " style='border-radius:10em;width:15%;max-width:125px;min-width:50px;'",
                i = " style='font-size:1.2em;'",
                o = " style='font-size:1em;'",
                r = " style='margin:" + d.margin + "% " + d.margin + "%;width:" + (100 - 2 * d.margin * d.items_per_row) / d.items_per_row + "%;float:left;'");
                var s = "";
                if (d.display_profile && (s = s + "<div class='instagram_profile'" + e + "><img class='instagram_profile_image' src='" + t.profile_pic_url + "' alt='" + (u ? t.name + " tag pic" : t.username + " profile pic") + "'" + n + " />",
                s = u ? s + "<p class='instagram_tag'" + i + "><a href='https://www.instagram.com/explore/tags/" + d.tag + "' rel='noopener' target='_blank'>#" + d.tag + "</a></p>" : s + "<p class='instagram_username'" + i + ">@" + t.full_name + " (<a href='https://www.instagram.com/" + d.username + "' rel='noopener' target='_blank'>@" + d.username + "</a>)</p>",
                !u && d.display_biography && (s += "<p class='instagram_biography'" + o + ">" + t.biography + "</p>"),
                s += "</div>"),
                i = void 0 !== f[d.image_size] ? f[d.image_size] : f[640],
                d.display_gallery)
                    if (void 0 !== t.is_private && !0 === t.is_private)
                        s += "<p class='instagram_private'><strong>This profile is private</strong></p>";
                    else {
                        for (n = (o = (t.edge_owner_to_timeline_media || t.edge_hashtag_to_media).edges).length > d.items ? d.items : o.length,
                        ...
                        e = 0; e < n; e++) {
                            ...
                            case "GraphVideo":
                                l = "video",
                                c = o[e].node.thumbnail_src;
                                break;
                            default:
                                l = "image",
                                c = o[e].node.thumbnail_resources[i].src
                            }
                            s += "<a href='" + a + "' class='instagram-" + l + "' rel='noopener' target='_blank'>",
                            s += "<img src='" + c + "' alt='" + (void 0 !== o[e].node.edge_media_to_caption.edges[0] ? o[e].node.edge_media_to_caption.edges[0].node.text : void 0 !== o[e].node.accessibility_caption ? o[e].node.accessibility_caption : (u ? t.name : t.username) + " image " + e) + "'" + r + " />",
                            s += "</a>"
                        }
                        s += "</div>"
                    }
                if (d.display_igtv && void 0 !== t.edge_felix_video_timeline && (n = (t = t.edge_felix_video_timeline.edges).length > d.items ? d.items : t.length,
                0 < t.length)) {
                    for (s += "<div class='instagram_igtv'>",
                    e = 0; e < n; e++)
                        s += "<a href='https://www.instagram.com/p/" + t[e].node.shortcode + "' rel='noopener' target='_blank'>",
                        s += "<img src='" + t[e].node.thumbnail_src + "' alt='" + d.username + " instagram image " + e + "'" + r + " />",
                        s += "</a>";
                    s += "</div>"
                }
